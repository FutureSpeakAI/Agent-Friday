...
gh release create v3.6.1 `
  --title "Agent Friday v3.6.1 — Cloud-Only UX & Key Validation" `
  --notes-file "release\release-notes.md" `
  "release\Agent Friday Setup 3.6.1.exe"
