...
#
# GENERATED by scripts/gen_installer_ladder.py from model_plan.BRAIN_MODELS —
...
$brainLadder = @(
    ...
    @{ Id = 'gemma4:e4b'; Needs =  3.01; Gb =  9.60; Says = 'a solid everyday model' },
    @{ Id = 'gemma4:12b'; Needs =  7.54; Gb =  7.60; Says = 'the model Friday is tuned and measured against' },
    @{ Id = 'gemma4:26b'; Needs = 16.99; Gb = 19.00; Says = 'the largest Friday offers - closest to a cloud model for tools and multi-step work' }
)
...
#
# GENERATED by scripts/gen_installer_ladder.py — the literal below is
# model_plan.FLOOR_MODEL's id as of the last generation, not a re-typed guess.
# BEGIN GENERATED: localIsComfortable
$localIsComfortable = ($null -ne $brainPick -and $brainPick.Id -ne 'gemma4:e2b')
