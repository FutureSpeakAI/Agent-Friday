...
def _notif_push(**kwargs):
    ...
    try:
        from services.voice_engine import _notif_engine
        if _notif_engine:
...
def _google_signals() -> list[str]:
    ...
    try:
        from services.calendar_engine import _fetch_calendar_today
    ...
    try:
        from services.calendar_engine import _fetch_gmail_recent
