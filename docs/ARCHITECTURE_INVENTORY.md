...
**18 Workspaces** (`wsMap`, grouped Life / Work / System):
`HomeWS · MessagesWS · CalendarWS · FamilyWS · CoparentWS · HealthWS · FinanceWS` (Life) ·
...
finance/health/family/co-parenting workspaces · FutureSpeak business pipeline · contacts research ·
