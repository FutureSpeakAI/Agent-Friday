...
| --- | --- | --- |
| `services/news_engine.py` | **+160 lines** | Denver-local RSS feeds (KUT, KXAN, KVUE, Texas Tribune); Local beat bumped 3 → 4 |
...
not just the metro area. The town name is the problem; "Denver, TX" is not.
...
useful content survives as "wired to Denver, TX at the maintainer's request".
