...
- Prior design docs this composes with: [`residency-policy.md`](../implemented/residency-policy.md)
  (the Arbiter and leases §4.6 deliberately does not touch),
  [`symphony-of-intelligence.md`](../implemented/symphony-of-intelligence.md) (the heavy-work proposal
  §4.6 completes), [`deep-research.md`](../active/deep-research.md) (the judgment gate and the
