...
the prompt-token audit (an unpublished working note) (cited **AUDIT**). What is
...
- the prompt-token audit (an unpublished working note) — the live turn
  ...
  accordingly.*
- [`docs/contracts/roles-and-model-identity.md`](../../reference/roles-and-model-identity.md)
