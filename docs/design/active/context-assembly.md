...
- the prompt-token audit (an unpublished working note) (final, live
...
- Prior design docs: [`residency-policy.md`](../implemented/residency-policy.md) (seat num_ctx, the
  ladder), [`conversations-and-concurrency.md`](../implemented/conversations-and-concurrency.md)
  (per-conversation transcripts; the stated-choice refuse shape),
  [`symphony-of-intelligence.md`](../implemented/symphony-of-intelligence.md) (the 15/15 chain battery
