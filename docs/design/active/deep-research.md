...
**Inherits:** [`residency-policy.md`](../implemented/residency-policy.md) (R1–R10, the Arbiter, the seats),
[`symphony-of-intelligence.md`](../implemented/symphony-of-intelligence.md) (S1–S4, the work queue, the
frontier-scopes/local-executes division), and the standing decisions in
[`decisions-2026-08.md`](../../decisions/2026-08-architecture-decisions.md).
...
> Research finished: *"What happened to the Denver housing-bond audit?"* — answered, 14
> claims confirmed across 9 sources, 2 struck in verification, 1 thing I couldn't confirm
> (flagged in the report). Full report: Research/denver-housing-bond-audit (opened in a new
...
- [`docs/design/residency-policy.md`](../implemented/residency-policy.md) — seats, budgets, the Arbiter,
  R1–R10.
- [`docs/design/symphony-of-intelligence.md`](../implemented/symphony-of-intelligence.md) — S1–S4, the work
