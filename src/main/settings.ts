/**
 * settings.ts — Persistent settings storage for EVE OS.
 * Stores to {userData}/eve-settings.json.
 */
...
/* ── Personality Evolution State (NexusCore visual uniqueness) ── */
...
export interface EveSettings extends AgentConfig {
  autoLaunch: boolean;
