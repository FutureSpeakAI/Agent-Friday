...
CONFORMANCE_PROMPTS = [
    ...
    {"id": "draft_email", "prompt": "Draft an email to my landlord at landlord@example.com — the heater's been out since last night, ask them to send someone today.", "expect_tool": "draft_email"},
