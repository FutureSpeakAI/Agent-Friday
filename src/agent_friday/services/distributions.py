...
BUILTIN_DISTROS = {
    "default": {
        ...
        "default_workspaces": ["news", "messages", "calendar", "career", "code", "knowledge", "contacts", "sites", "settings", "studio"],
    ...
    "journalist": {
        ...
        "default_workspaces": ["news", "messages", "calendar", "knowledge", "contacts", "settings", "studio", "content"],
        "default_providers": ["anthropic", "google-gemini", "ollama-local"],
    ...
    "developer": {
        ...
        "default_workspaces": ["code", "news", "messages", "calendar", "knowledge", "settings", "studio"],
    ...
    "researcher": {
        ...
        "default_workspaces": ["knowledge", "news", "code", "messages", "calendar", "contacts", "settings", "studio"],
        "default_providers": ["anthropic", "google-gemini", "ollama-local"],
        "default_recipes": ["morning-briefing"],
        "system_prompt_overrides": {
    ...
    "executive": {
        ...
        "default_workspaces": ["calendar", "messages", "news", "finance", "contacts", "settings", "studio"],
