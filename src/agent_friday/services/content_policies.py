    ...
    *content_metadata* recognized fields:
    ...
    if scan_text:
        try:
            ...
            # .scan (250 round-trips per approval card without it — see that
            # function's docstring). This call wants the H1-H4 floor;
    ...
    # this is redundant and harmless) and the actual fix for content that
    # doesn't (this is now the only check that can catch it).
