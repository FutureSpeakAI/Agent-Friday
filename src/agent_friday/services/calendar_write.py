...
def _already_there(current: str, addition: str) -> bool:
    ...
    "Kapsner Chiropractic Centers - North Denver, 9012 Research Blvd Ste C-7,
    Denver, TX 78758, USA". The address I was adding was not a substring of it
    (the existing one has "- North Denver" in the middle), so it appended and
