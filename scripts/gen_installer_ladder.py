...
BLURBS = {
    "qwen3:4b": "a small model - good for quick questions, weaker at long multi-step jobs",
    "qwen3:8b": "a solid everyday model",
    "gemma4:12b": "the model Friday is tuned and measured against",
    "qwen3:14b": "a strong model that handles multi-step work well",
    "qwen3:32b": "the largest Friday offers - closest to a cloud model for tools and multi-step work",
}
